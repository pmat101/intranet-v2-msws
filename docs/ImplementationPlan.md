...
S3.1 Port P-Code generation into `lib/ids.js` with the clash guard; golden tests: known historical inputs reproduce their exact live P-Codes. Verify: golden suite green.
